...
public class WeatherApp {
    public static void main(String[] args) {
        ...
        System.out.println(findByTemperatureMoreTemp(WeatherTestData.getWeatherList(), 35));
    }
   ...
   */
    public static boolean findByTemperatureMoreTemp(List<Weather> weatherList, int temperarure) {
        return weatherList.stream()
                .anyMatch(weather -> weather.getTemperature() > temperarure);
    }
}
